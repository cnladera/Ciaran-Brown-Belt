...
public class PlayerControls : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if ((Input.GetKey("space") || Input.GetKey("z")) && (Time.time > nextFire)) 
        {
            ...
            if (currentLevel >= 6)
            {
                Vector3 rightOffset = new Vector3(0.3f, -1, 0);
                Vector3 leftOffset = new Vector3(-0.3f, -1, 0);
                Instantiate(projectile, transform.position + rightOffset, transform.rotation);
                Instantiate(projectile, transform.position + leftOffset, transform.rotation);
            }
            ...
            if (currentLevel >= 9)
            {
                Vector3 rightOffset = new Vector3(0.4f, -2, 0);
                Vector3 leftOffset = new Vector3(-0.4f, -2, 0);
                Instantiate(projectile, transform.position + rightOffset, transform.rotation);
                Instantiate(projectile, transform.position + leftOffset, transform.rotation);
            }
            ...
            if (currentLevel >= 12)
            {
                Vector3 rightOffset = new Vector3(0.5f, -3, 0);
                Vector3 leftOffset = new Vector3(-0.5f, -3, 0);
                Instantiate(projectile, transform.position + rightOffset, transform.rotation);
                Instantiate(projectile, transform.position + leftOffset, transform.rotation);
            }
